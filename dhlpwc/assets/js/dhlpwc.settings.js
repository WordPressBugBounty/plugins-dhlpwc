jQuery(document).ready(function($) {
    ...
    $(document.body).on('click', 'input#woocommerce_dhlpwc_test_connection', function(e) {
        ...
        $('#dhlpwc_shipping_method_settings').css('visibility', 'visible');
        $('#dhlpwc_shipping_method_settings').parent().find('.woocommerce-centered-spinner').css('display', 'none');
        ...
        $('tr#dhlpwc-option-group-mirror-fallback').find('label:first-child').append(
          '<a href="#TB_inline?&width=800&height=150&inlineId=dhlpwc_fallback_info" class="thickbox">🛈</a>' +
          '<div id="dhlpwc_fallback_info" style="display:none;"><p>' + dhlpwc_settings_object.fallback_info + '</p></div>'
        );
