...
class DHLPWC_Controller_Checkout
{
    ...
    public function set_parcelshop_hooks()
    {
        if (function_exists('register_block_type_from_metadata')) {
            // For the blocks variant of the WC checkout
            register_block_type_from_metadata( DHLPWC_PLUGIN_DIR . DIRECTORY_SEPARATOR . 'build' );
        }
    ...
    public function add_option_meta_block_checkout($order)
    {
        ...
        $this->add_option_meta($order->get_id(), $data);
    }
