...
class DHLPWC_Model_Service_Shipping_Preset extends DHLPWC_Model_Core_Singleton_Abstract
{
    ...
    public function get_presets()
    {
        return array(
            ...
            array(
                'frontend_id' => 'fallback',
                'setting_id' => 'fallback',
                'title' => __('Standard delivery', 'dhlpwc'),
                'options' => array(
                    DHLPWC_Model_Meta_Order_Option_Preference::OPTION_DOOR,
                ),
                'information' => 'Allow DHL eCommerce to show a fallback when there\'s an invalid configuration or when the DHL eCommerce API is unreachable.',
            ),
        );
    }
