...
if (!class_exists('DHLPWC_Model_Service_Label_Metabox')) :
    ...
    class DHLPWC_Model_Service_Label_Metabox extends DHLPWC_Model_Core_Singleton_Abstract
    {
        ...
        protected $whitelist = array(
            ...
            DHLPWC_Model_Meta_Order_Option_Preference::OPTION_LQ,
        );
        ...
        public function sizes_form($order_id, $selected_options, $to_business)
        {
            ...
            if (!empty($sizes)) {
                ...
                if (in_array(DHLPWC_Model_Meta_Order_Option_Preference::OPTION_LQ, $selected_options)) {
                    $lq_weight_form = new DHLPWC_Template('order.meta.form.lq_weight_form');
                    $size_view .= $lq_weight_form->render(array(), false);
                }
