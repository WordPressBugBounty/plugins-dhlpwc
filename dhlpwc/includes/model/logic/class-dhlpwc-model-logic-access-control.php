...
class DHLPWC_Model_Logic_Access_Control extends DHLPWC_Model_Core_Singleton_Abstract
{
    ...
    public function check_default_ssn()
    {
        $shipping_method = get_option('woocommerce_dhlpwc_settings');
        ...
        if (!isset($shipping_method['default_hide_sender_address_service'])) {
            return false;
        }

        if ($shipping_method['default_hide_sender_address_service'] != 'yes') {
            return false;
        }
